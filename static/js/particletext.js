// ParticleText Vanilla JS Implementation
...
window.initParticleText = function(container, options = {}) {
  const {
    text = 'React Bits',
    particleSize = 2,
    density = 4,
  ...
  screenReaderText.style.position = 'absolute';
  screenReaderText.style.width = '1px';
  screenReaderText.style.height = '1px';
  screenReaderText.style.padding = '0';
  screenReaderText.style.margin = '-1px';
  screenReaderText.style.overflow = 'hidden';
  screenReaderText.style.clip = 'rect(0, 0, 0, 0)';
  screenReaderText.style.whiteSpace = 'nowrap';
  screenReaderText.style.borderWidth = '0';
  screenReaderText.textContent = text;
  container.appendChild(screenReaderText);
