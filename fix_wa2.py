...
wa_cert_button = """                            <!-- Send WA Cert Button -->
                            ...
                            <a href="https://wa.me/91{{ row.phone|replace(' ', '')|replace('+91', '') }}?text={{ wa_msg | urlencode }}" target="_blank" class="btn btn-sm" style="background-color: #25D366; color: white; border-color: #25D366;">📱 WA</a>"""
